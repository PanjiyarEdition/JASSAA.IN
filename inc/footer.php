<div class="container-fluid bg-dark mt-5">
  <div class="row">
    <div class="col-lg-4 p-4">
      <h3 class="h-font fw-bold fs-3 mb-2 text-warning"><?php echo $settings_r['site_title'] ?></h3>
      <p class="text-white">
...
<h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by <b class="text-warning">JASSAA.in</b> INTERN</h6>
